          ...
          <div className="w-full px-32">
            ...
            <form autoComplete="off" onSubmit={handleSubmit(onSubmit)}>
              ...
              <input
                ...
                placeholder="Full Name"  {...register('fullName', { required: 'full name is require' })} />
              {
                errors.fullName && (
              ...
              <input
                className="bg-zinc-100 block w-full px-3 py-2 border rounded-md mb-3 border-zinc-200"
                type="password" placeholder="Password" {...register('password', { required: 'password is require' })} />
              {
                errors.password && (
