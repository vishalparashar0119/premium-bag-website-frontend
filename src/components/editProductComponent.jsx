...
const EditProduct = (props) => {
      ...
      useEffect(() => {
            if (product) {
                  reset({
                        ...
                        pannelColor: product.pannelColor || '',
      ...
      return (
            <>
                  ...
                  <div className="min-h-screen flex justify-center items-center w-full fixed top-0 bg-black/30">
                        <main className="w-3/4 bg-white p-8 shadow rounded-md">
                              ...
                              <form autoComplete="off" encType="multipart/form-data" onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <button onClick={() => setToggle(false)} className='px-5 py-2 rounded  ml-2 mt-3 bg-yellow-500 text-black cursor-pointer'>
                                          Cancle
                                    </button>
                              </form>
                        </main>
